<?php
/**
 * Spectrum-agency functions and definitions
 *
...
if ( ! function_exists( 'spectrum_agency_setup' ) ) :
/**
 ...
 */
function spectrum_agency_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Spectrum-agency, use a find and replace
	 * to change 'spectrum-agency' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'spectrum-agency', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'spectrum-agency' ),
	) );
    
    register_nav_menus( array(
        'primary' => __( 'Primary Menu', 'spectrum-agency' ),
) );
...
add_action( 'after_setup_theme', 'spectrum_agency_setup' );
...
function spectrum_agency_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'spectrum-agency' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'spectrum-agency' ),
...
function spectrum_agency_scripts() {
	wp_enqueue_style( 'spectrum-agency-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'spectrum-agency-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'spectrum-agency-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
